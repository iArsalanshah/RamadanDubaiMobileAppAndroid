...
public class MainActivity extends DockActivity implements OnClickListener {
    ...
    private void settingSideMenu(String type, String direction) {
        if (type.equals(SideMenuChooser.DRAWER.getValue())) {
            ...
            sideMenuFragment = SideMenuFragment.Companion.newInstance();
    ...
    private void setMenuItemDirection(String direction) {
        ...
        if (direction.equals(SideMenuDirection.LEFT.getValue())) {
            ...
            SideMenuFragment leftSideMenuFragment = SideMenuFragment.Companion.newInstance();
            ...
            SideMenuFragment rightSideMenuFragment = SideMenuFragment.Companion.newInstance();
    ...
    public void initFragment() {
        ...
        replaceDockableFragment(HomeFragment.Companion.newInstance(), "HomeFragment");
    }
